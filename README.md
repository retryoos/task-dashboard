...
- The layout uses the Bootstrap grid, so columns stack on phones and the menu becomes
  a hamburger. I checked it at phone, tablet, and desktop widths.

## What was hardest

I rewrote the filtering a few times. I kept changing the main task array by accident
while filtering it, which dropped tasks. Once I made the filter return a copy and
leave the original alone, it was fine. The row buttons were the other tricky bit until
I switched to event delegation.
